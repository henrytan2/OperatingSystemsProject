...
if __name__ == '__main__':
    ...
    for n in range(2):
        ...
        for i in range(100):
            upload-test = get_files(config[source_folder]+"/upload-test")
            time_taken = upload(upload-test, config["azure_storage_connectionstring"], config["upload-test_container_name]")
